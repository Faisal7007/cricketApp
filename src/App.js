...
function App() {
  ...
  //             "w": 6,
  //             "o": 20,
  //             "inning": "Bangladesh A Women Inning 1"
  //           },
  //           {
  //             "r": 51,
  //             "w": 8,
  //             "o": 20,
  //             "inning": "Malaysia Women Inning 1"
  //           }
  //         ],
  ...
  //             "w": 7,
  //             "o": 19.5,
  //             "inning": "Sri Lanka A Women Inning 1"
  //           }
  //         ],
  //         "series_id": "700d6740-82d3-4621-9c07-e274afc8b640",
  //         "fantasyEnabled": true,
  ...
  //             "w": 9,
  //             "o": 20,
  //             "inning": "Belgium Inning 1"
  //           },
  //           {
  //             "r": 150,
  //             "w": 2,
  //             "o": 13,
  //             "inning": "Germany Inning 1"
  //           }
  //         ],
  ...
  //             "w": 10,
  //             "o": 17.1,
  //             "inning": "Botswana Women Inning 1"
  //           },
  //           {
  //             "r": 57,
  //             "w": 2,
  //             "o": 10.5,
  //             "inning": "Kenya Women Inning 1"
  //           }
  //         ],
  ...
  //             "w": 5,
  //             "o": 20,
  //             "inning": "Nigeria Women Inning 1"
  //           },
  //           {
  //             "r": 101,
  //             "w": 5,
  //             "o": 18.1,
  //             "inning": "Uganda Women Inning 1"
  //           }
  //         ],
  //         "series_id": "31494430-655e-4a9f-8c2c-e94b24608168",
  //         "fantasyEnabled": true,
  ...
  //         "matchType": "test",
  //         "status": "Day 1: Stumps - Sri Lanka A opt to bat",
